function  [mesh , Joints] = updateSmplModelswithBeta(Theta,Beta, T_mean,kintree_table,J_regressor,weights,ShapeTensor)
%% 
N = length(T_mean);
for i=1:10
    T_mean = T_mean + Beta(i) * ShapeTensor(i*N-N+1:i*N,:);
end
